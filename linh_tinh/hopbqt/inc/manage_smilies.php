...
<?
$smfile = $root['chatdata'].'adminkute_smilies.txt';

if ($_GET['do'] == 'showsmilies')
{
echo '<form name="adminkute_smilie" action="?admin&act=manage_smilies&do=save" method="post">';
...
if ($_GET['do'] == 'formadd')
{
	echo '<form name="adminkute_smilieadd" action="?admin&act=manage_smilies&do=add" method="post">';
	for ($i = 0; $i<100; $i++)
	{
