...
var va="email".split(',') //Put the ID of the fields you DON'T want to let users type Vietnamese in, multiple fields allowed, separated by a comma (,)
var fID="vB_Editor_QR_iframe,vB_Editor_QE_1_iframe,vB_Editor_001_iframe,vB_Editor_002_iframe".split(',') //Put the ID of the iframes you want to let users type Vietnamese in separated by a comma (,)
