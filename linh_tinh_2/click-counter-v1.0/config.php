...
$dbpass = "public123"; // YOUR DATABASE PASSWORD
$dbtable = "test";// THE NAME OF YOUR DATABASE , THIS SHOULD HAVE BEEN SET WHEN YOU INSTALLED click_db.sql, SO YOU CAN LEAVE THIS
