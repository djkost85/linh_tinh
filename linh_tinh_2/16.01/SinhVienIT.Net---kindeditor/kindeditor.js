...
*
* @author kindsoft dev team
* @site http://www.kindeditor.com/
...
KE.lang = {
	...
	wordpaste : 'Paste from MS Word',
	selectall : 'Select all',
	justifyleft : 'Align text left',
	justifycenter : 'Align text center',
	justifyright : 'Align text right',
	justifyfull : 'Distributed',
	...
	image : 'Picture',
	flash : 'Insert Flash',
	media : 'Insert multimedia',
	table : 'Insert table',
	hr : 'Insert order line',
	emoticons : 'Insert emotion',
	link : 'Hyperlink',
	...
	deleteLink : 'Remove hyperlink',
	noColor : 'Transparent',
	invalidImg : "Invalid URL address. \n Jpg, gif, bmp,png allowed only.",
	invalidMedia : "Invalid URL address. \n Swf, flv, mp3, wav, wma, wmv, mid, avi, mpg, asf, rm, rmvb allowed only.",
	invalidWidth : "Number acceptted only.",
	invalidHeight : "Number acceptted only.",
	invalidBorder : "Number acceptted only.",
	invalidUrl : "Invalid URL address.",
	pleaseInput : "Input content here.",
	cutError : 'Operation not allowed by your browser. Please do by pressing (Ctrl+X).',
	copyError : 'Operation not allowed by your browser. Please do by pressing (Ctrl+C).',
	pasteError : 'Operation not allowed by your browser. Please do by pressing (Ctrl+V).'
};
