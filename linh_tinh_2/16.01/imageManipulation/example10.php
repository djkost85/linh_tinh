<?php
	...
	if(isset($_POST['upload'])){
		...
		if($handle->uploaded){
			...
			if ($handle->processed) {
				$message = '<div class="center"><p> Text watermark added successfully</p><img src="uploads/'.$handle->file_dst_name.'?'.time().'" alt="" /></div>';
			}
		}
	}
?>
	...
	<div id="body">
		<div id="image">
			<?php
				...
				{
					echo '<h1> Adding Text Watermark to the image </h1>';
				}
			?>
		</div><!-- end image -->	
		<div id="form">
			<form method="post" action="example10.php" enctype="multipart/form-data">
