<?php
	...
	if(isset($_POST['upload'])){
		...
		if($handle->uploaded){
			...
			if ($handle->processed) {
				$message = '<div class="center"><p> GrayScale filter added successfully</p><img src="uploads/'.$handle->file_dst_name.'?'.time().'" alt="" /></div>';
			}
		}
	}
?>
	...
	<div id="body">
		<div id="image">
			<?php
				...
				{
					echo '<h1> Adding GrayScale filter </h1>';
				}
			?>
		</div><!-- end image -->	
		<div id="form">
			<form method="post" action="example9.php" enctype="multipart/form-data">
