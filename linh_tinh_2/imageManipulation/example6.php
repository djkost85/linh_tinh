<?php
	...
	if(isset($_POST['upload'])){
		...
		if($handle->uploaded){
			...
			if ($handle->processed) {
				$message = '<div class="center"><p>Opacity changed to 50% </p><img src="uploads/'.$handle->file_dst_name.'?'.time().'" alt="" /></div>';
			}
		}
	}
?>
	...
	<div id="body">
		<div id="image">
			<?php
				...
				{
					echo '<h1> Setting opacity for border color </h1>';
				}
			?>
		</div><!-- end image -->	
		<div id="form">
			<form method="post" action="example6.php" enctype="multipart/form-data">
