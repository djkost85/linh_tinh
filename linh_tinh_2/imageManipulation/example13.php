<?php
	...
	if(isset($_POST['upload'])){
		...
		if($handle->uploaded){
			...
			$handle->image_reflection_height = $handle->image_dst_y;
			$handle->process('uploads/');
			if ($handle->processed) {
				$message = '<div class="center"><p> Ohhh i love reflections </p><img src="uploads/'.$handle->file_dst_name.'?'.time().'" alt="" /></div>';
			}
		}
	}
?>
	...
	<div id="body">
		<div id="image">
			<?php
				...
				{
					echo '<h1> Adding Image Reflection </h1>';
				}
			?>
		</div><!-- end image -->	
		<div id="form">
			<form method="post" action="example13.php" enctype="multipart/form-data">
