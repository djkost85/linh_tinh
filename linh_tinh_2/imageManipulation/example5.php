<?php
	...
	if(isset($_POST['upload'])){
		...
		if($handle->uploaded){
			...
			$handle->image_border_color    = '#F58462';			
			$handle->process('uploads/');
			if ($handle->processed) {
				$message = '<div class="center"><p>Border color #F58462 added successfully</p><img src="uploads/'.$handle->file_dst_name.'?'.time().'" alt="" /></div>';
			}
		}
	}
?>
	...
	<div id="body">
		<div id="image">
			<?php
				...
				{
					echo '<h1> Adding 5px solid border orange color </h1>';
				}
			?>
		</div><!-- end image -->	
		<div id="form">
			<form method="post" action="example5.php" enctype="multipart/form-data">
