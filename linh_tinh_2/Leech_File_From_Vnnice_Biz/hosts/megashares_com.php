...
if($ms == "ok"){
	...
	if(preg_match('/Your Passport needs to be reactivated/', $page)){
		...
		print 	"<form method=\"post\" action=\"$PHP_SELF\" name=\"msform\">$nn";
