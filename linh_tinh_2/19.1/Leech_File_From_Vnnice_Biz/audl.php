...
<title>RAPIDLEECH PLUGMOD - Auto Download</title>
<style type="text/css">
<!--
...
if ($_REQUEST["GO"] == "GO")
	{
		...
		$start_link.='&premium_acc='.$_REQUEST[rapidpremium_com];
		...
		for ($i=0; $i<count($getlinks); $i++)
			{
				...
				echo "<td width=70 id=action".$i."><input type=button onClick=javascript:download($i); value='Download' id=dButton".$i."></td>";
				echo "<td width=70 id=status".$i.">&nbsp;</td>";
				echo "</tr>\n";
			}
?>
<tr id=auto><td colspan=3 align=center>Intervals (1 ... 3600)&nbsp;<input type=text id=delay name=delay size=5 value=20>&nbsp;seconds&nbsp;<input type=button value='Start auto download' onClick=javascript:startauto();></tr>
</table>
<?php
...
<tr><td><textarea id=links name=links rows=15 cols=60 style="width:600px; height:400px; border:1px solid #002E43"></textarea></td><td valign=top><input type=submit value="Download files" onClick=javascript:HideAll(); style="width:100px;"></tr>
</table>
</div>
