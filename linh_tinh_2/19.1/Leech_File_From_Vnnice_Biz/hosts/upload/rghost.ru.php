...
if ($_REQUEST['action'] == "delete"){
	...
	is_page($dpage);
	$cookies = GetCookies($dpage,true);unset($post);
...
if($continue_up==true){
					...
					//Получаем куки.
					$cookies = GetCookies($upfiles,true);
					//Смотрим номер файла.
