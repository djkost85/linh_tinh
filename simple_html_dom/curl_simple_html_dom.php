...
function file_get_html() {
    ...
    $args = func_get_args();
    $dom->load(call_user_func_array('curl_get_html', $args), true);
    return $dom;
}
...
class simple_html_dom {
    ...
    function load_file() {
        $args = func_get_args();
        $this->load(call_user_func_array('curl_get_html', $args), true);
    }
    ...
    function loadFile() {$args = func_get_args();$this->load(call_user_func_array('curl_get_html', $args), true);}
}
?>